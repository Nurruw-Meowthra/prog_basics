...
def ask_name_and_greet_user():
    ...
    # Check if the name is "Thanos" (case insensitive)
...
def calculate_cathetus_length(a: float, c: float) -> float:
    ...
    cathetus_squared = c ** 2 - a ** 2
    return math.sqrt(cathetus_squared)
...
if __name__ == '__main__':
    ...
    print(calculate_cathetus_length(3, 5))  # should print 4.0"""Basic function exercises."""
