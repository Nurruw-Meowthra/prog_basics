...
create_tuple_from_two_numbers(1, 19)
...
def insert_tuple_inside_tuple(outer_tuple: tuple, position: int, inner_tuple: tuple) -> tuple:
    ...
    """
    plep = outer_tuple[:position]
    mlep = outer_tuple[position:]
    mau = plep + inner_tuple + mlep
    return mau
